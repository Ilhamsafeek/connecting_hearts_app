...
import 'package:connecting_hearts/ui/screens/tabElements/dashboardContent/echarity/payment_result.dart';
...
class _ProjectDetailPageState extends State<ProjectDetail> {
  ...
  dynamic lkrAmount = 0;
    ...
    if (data['status'] == 'success') {
      var saleResponse = await Braintree(mApiListener).sale(usdAmount,lkrAmount,

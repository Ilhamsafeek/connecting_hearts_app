...
class _ProjectDetailPageState extends State<ProjectDetail> {
  ...
  Widget _detailSection() {
    ...
    FlutterMoneyFormatter formattedRemainingAmount =
        FlutterMoneyFormatter(amount: remainingAmount);
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      new Text(
                          '${formattedRaised.output.withoutFractionDigits}',
                          style: TextStyle(fontSize: 24)),
                    ],
                  ),
                  flex: 6,
              ...
              children: [
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      new Text('Balance ${currentUserData['currency']}', style: TextStyle(fontSize: 20)),
                    ],
                  ),
                  flex: 7,
                ),
                Expanded(
                  child: Column(
                    ...
                    children: [
                      new Text(
                          '${formattedRemainingAmount.output.withoutFractionDigits}',
                          style: TextStyle(fontSize: 24)),
                    ],
                  ),
                  flex: 6,
              ...
              child: Row(
                children: <Widget>[
                  Expanded(
                    ...
                    label: Text("Donate", style: TextStyle(fontSize: 16),),
                    color: Colors.amber,
                  )),
                ],
              ),
  ...
  _navigateToPayment() async {
    if (this.selectedMethod == 'bank') {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => Checkout(selectedMethod, widget.projectData,
      ...
      var data = await braintreePayment.showDropIn(
          nonce: companyData['tokenized_key'],
